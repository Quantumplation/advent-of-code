...
fn main() -> Result<()> {
    println!("1.1) {:?}", solve("day1.txt", vec_of, day1::part1::solve)?);
    println!("1.2) {:?}", solve("day1.txt", vec_of, day1::part2::solve)?);
    println!("2.1) {:?}", solve("day2.txt", vec_of, day2::part1::solve)?);
    println!("2.2) {:?}", solve("day2.txt", vec_of, day2::part2::solve)?);
    println!("3.1) {:?}", solve("day3.txt", vec_of, day3::part1::solve)?);
    println!("3.2) {:?}", solve("day3.txt", vec_of, day3::part2::solve)?);
